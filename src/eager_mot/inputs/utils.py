...
import eager_mot.inputs.utils_io_ab3dmot as ab3dmot_io
from eager_mot.configs.local_variables import MOUNT_PATH, SPLIT
from eager_mot.dataset_classes.nuscenes.classes import id_from_name as id_nuscenes_from_name
from eager_mot.dataset_classes.kitti.classes import id_from_name as id_kitti_from_name
...
def det_pointrcnn_files_lists_all():
    return [ab3dmot_io.load_list_from_folder(os.path.join(DETECTIONS_AB3DMOT, split_file))[0] for split_file in
            _SPLITS_AB3DMOT]
