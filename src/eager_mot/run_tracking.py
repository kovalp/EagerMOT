...
from eager_mot.configs.params import KITTI_BEST_PARAMS, NUSCENES_BEST_PARAMS, variant_name_from_params
from eager_mot.configs.local_variables import KITTI_WORK_DIR, SPLIT, NUSCENES_WORK_DIR
