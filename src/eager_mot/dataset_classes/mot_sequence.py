...
import eager_mot.inputs.bbox as bbox
from eager_mot.tracking.tracking_manager import TrackManager
...
from eager_mot.configs.params import variant_name_from_params
...
class MOTSequence(ABC):
    ...
    @abstractmethod
    def get_frame(self, frame_name: str) -> mot_frame.MOTFrame:
        pass
